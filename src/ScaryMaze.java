...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("maze1.jpg"));
 ...
 addMouseMotionListener(this);
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("5.wav"));
	...
	private void showScaryImage(String scary) {
		try {
			maze = ImageIO.read(getClass().getResource(scary));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + scary);
		}
		repaint();
	}
